...
if (request_is_same_domain() and request_is_post()) {
    $form_params_customer = ['customer_name', 'gym_id', 'telephoneInput', 'snapshot_data',
          ...
          <div class="col-md-12 form_space">
            ...
            <div class="form-group has-feedback">
                <div class="input-group">
                    ...
                    <select class="js-data-example-ajax form-control show-tick"
           ...
           <div class="form-group collapse">
            ...
            <div class="col-md-12 bs-callout bs-callout-default">
                ...
                action="dailyIncome.php" method="post" enctype="multipart/form-data">
                <div class="col-md-12 form_space">
                ...
                <div class="form-group row form_space">
                    ...
                    <div class="col-xs-10">
                        ...
                        <div class="col-xs-12" style="margin-bottom: 20px;">
                            <div class="col-xs-6" id="my_camera" style="width:260px; height:180px;"></div>
                            <div class="col-xs-5 col-xs-offset-1" id="my_result" style="padding-left: 30px;">HERE THE IMAGE WILL BE DISPLAYED</div>
                        </div>
                    </div><!-- /.col-xs-10 -->
                </div><!-- /.form-group row form_space has-feedback -->
