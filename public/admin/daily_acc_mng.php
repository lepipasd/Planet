...
<div class="container-fluid main_center">
  ...
  <div class="col-md-12 content">
    <h2 style="padding-top: 10px;">Report <span class="glyphicon glyphicon-transfer"></span></h2>
    <div class="container alert alert-info message">
      <span class="glyphicon glyphicon-info-sign"></span>
        <?php
          $msg  = "Report daily income or outcome.";
          echo !empty($message) ? output_message($message) : output_message($msg);
        ?>
    </div><!-- /.alert alert-info message -->
    <div class="container pills">
        <?php
          echo Navigation::display_administration_pills(1, 2, $session->role_id);
        ?>     
    </div><!-- /.container.pills -->
